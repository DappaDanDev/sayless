        ...
        const fncCtx = {
            ...
            getWalletBalance: {
                ...
                parameters: z.object({
                    ...
                    chain: z.enum(Object.keys(CHAIN_IDS)).describe('The blockchain to check'),
                }),
                execute: async ({ addressOrName, chain }) => {
                    ...
                    try {
                        ...
                        const response = await fetch(`https://api.1inch.dev/balance/v1.2/${chainId}/balances/${resolvedAddress}`, {
                            headers: {
            ...
            getTransactionHistory: {
                ...
                execute: async ({ addressOrName, chain, limit }) => {
                    ...
                    try {
                        ...
                        const historyResponse = await fetch(`${historyUrl}?${params}`, {
                            method: 'GET',
                            headers: {
                                'Authorization': `Bearer ${process.env.INCH_API_KEY}`,
                                'Accept': 'application/json'
            ...
            createCircleWallet: {
                ...
                execute: async ({ blockchain, accountType }) => {
                    ...
                    try {
                        ...
                        console.log((_a = walletResponse.data) === null || _a === void 0 ? void 0 : _a.wallets[0].address);
                        return `Successfully created a new ${accountType} wallet on ${blockchain}:
              Address: ${(_b = walletResponse.data) === null || _b === void 0 ? void 0 : _b.wallets[0].address}
              Blockchain: ${(_c = walletResponse.data) === null || _c === void 0 ? void 0 : _c.wallets[0].blockchain}`;
                    }
                    catch (error) {
